...
class TestProgressCallback(unittest.TestCase):
    ...
    def test_progress_callback_structure(
        self, mock_find_duplicates, mock_export_report, mock_console
    ):
        ...
        self.assertGreater(
            len(captured_progress), 0, "Should have captured progress updates"
        )
...
class TestTUIEnhancements(unittest.TestCase):
    ...
    def test_emoji_status_mapping(self):
        ...
        for phase in expected_phases:
            ...
            self.assertIsInstance(
                status_emoji[phase], str, f"Emoji should be string for {phase}"
            )
    ...
    def test_memory_usage_coloring_logic(self):
        ...
        for memory_percent, expected_color in test_cases:
            ...
            self.assertEqual(
                color, expected_color, f"Wrong color for {memory_percent}% memory usage"
            )
...
class TestTUIIntegration(unittest.TestCase):
    ...
    def test_full_tui_search_integration(self, mock_export_report, mock_console):
        ...
        expected_elements = ["PhotoChomper", "Starting", "Search", "optimization"]
    ...
    def test_skip_sha256_display(self, mock_console):
        ...
        output_text = " ".join(console_output)
        skip_indicators = ["skip", "SHA256", "exact duplicate", "warning"]
        ...
        self.assertTrue(
            any("skip" in output.lower() for output in console_output),
...
class TestProgressDisplayLogic(unittest.TestCase):
    ...
    def test_eta_calculation_display(self):
        ...
        self.assertEqual(
            stats_no_eta.estimated_completion_time,
            0.0,
            "Completed phase should have zero ETA",
        )
