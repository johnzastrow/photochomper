...
def show_table_format():
    ...
    print()
    print(
        "Status       File                           Size      Modified          Resolution  Quality"
    )
    print(
        "👑 MASTER    /home/user/photos/img001.jpg   2.1 MB    2023-05-15 14:30  1920x1080   4147.2"
    )
    print(
        "#1 DUPLICATE /home/user/backup/img001.jpg   2.1 MB    2023-05-15 14:30  1920x1080   4147.2"
    )
    print(
        "#2 DUPLICATE /home/user/temp/copy_img.jpg   1.8 MB    2023-05-16 09:15  1920x1080   3456.0"
    )
    print()
    print("📋 Group Summary:")
    ...
    print(
        "• Choose 'd' to delete duplicates, 'm' to move them, or 'k' to select different master"
    )
