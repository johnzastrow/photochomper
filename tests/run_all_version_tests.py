...
def main():
    ...
    parser.add_argument(
        "--version-tests", action="store_true", help="Run only version-specific tests"
    )
    parser.add_argument(
        "--regression-tests", action="store_true", help="Run only regression tests"
    )
    parser.add_argument(
        "--integration-tests", action="store_true", help="Run only integration tests"
    )
