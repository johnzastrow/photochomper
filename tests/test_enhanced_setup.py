...
def show_setup_workflow():
    ...
    workflow_steps = [
        ...
        ("📄 File Types", "jpg, jpeg, png, gif, bmp, tiff", "Choose file extensions to include"),
        ...
        ("📋 Master File Selection", "shorter paths", "Which duplicate to keep as master"),
        ("📂 Duplicate Management", "~/Pictures/duplicates_to_review", "Where to move duplicates in --review"),
        ("💾 Configuration File", "photochomper_config_TIMESTAMP.conf", "Where to save settings"),
...
def show_before_after_comparison():
    ...
    print("\n❌ OLD SETUP PROMPT:")
    print("Enter directories to scan (comma separated) [default: /home/user/Pictures]: ")
